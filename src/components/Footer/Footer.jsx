        ...
        <div className='footer  lg:px-[135px] py-[100px]' style={{ fontFamily: 'Neue Montreal' }}>
            <div className='lg:flex w-full'>
                <div className='lg:w-[50%] flex justify-center'>
                    <div className='lg:w-[413px]  rounded-[20px] p-[30px]  footer_border'>
                        <div className='text-white text-[43px] font-medium mx-5 text-center'><h1 style={{ fontFamily: 'Neue Montreal' }}>Let’s Stay In Touch</h1></div>
                ...
                <div className='lg:w-[50%] mt-12 grid grid-cols-1 lg:grid-cols-2'>
                    <div>
            ...
            <div className='w-full flex my-12'>
                ...
                <div className='w-[50%]'>
                    ...
                    <div className='flex gap-3 items-center mt-3 lg:pe-20'>
